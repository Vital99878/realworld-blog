...
const Header = ({ isSignUp, username, image, logOut }) => (
  <div className={cn("header-container")}>
    <header className={cn("header")}>
      <Link className={cn("title")} to="/">Realworld Blog</Link>
      {!isSignUp && 
        <>
          <Link className={cn("button", "button--sign-in")} to="/sign-in">Sign In</Link>
          <Link className={cn("button", "button--sign-up")} to="/sign-up">Sign Up</Link>
        </>
      }
      {isSignUp && 
        <>
          <Link className={cn("create-article")} to="/new-article">Create article</Link>
          <Link to="/profile">
